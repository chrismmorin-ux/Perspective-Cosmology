...
print("     vs measured 137.035999177. Error (2-loop): 0.0009 ppm (5.9 sigma);")
print("     3-loop D_3=1: 0.0006 sigma [CONJ, HRS 5].")
...
print("  - Total predictions: 2 (alpha: 2-loop 5.9σ, 3-loop D_3=1: 0.0006σ [CONJ]; Omega_m: 0.04σ)")
print()
