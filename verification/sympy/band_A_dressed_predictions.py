...
predictions.append(("C", "1/alpha", "24/11", f"{float(alpha_tree_inv):.6f}",
    ...
    f"{alpha_inv_resid:.4f}", "2-loop: 5.9 sigma; 3-loop D_3=1: 0.0006 sigma [CONJ]"))
...
print("""
  ...
  The discriminating power comes from PRECISION: C_2=24/11 [DERIVATION]; 2-loop: 5.9 sigma; 3-loop D_3=1: 0.0006 sigma [CONJ].
""")
