...
So 29 IS a framework prime: 29 = 5² + 2² = 25 + 4

This means 29 should have a framework interpretation.
""")

# Verify
print(f"29 = 5² + 2² = {5**2} + {2**2} = {5**2 + 2**2}")
...
expressions = [
    ("5² + 2²", 5**2 + 2**2, "pentagon² + C² — pentagons + complex"),
    ...
    ("H² + Im_H² + Im_O - 3", H**2 + Im_H**2 + Im_O - 3, "H² + 9 + 7 - 3"),
    ("C² + 5²", C**2 + 5**2, "complex² + pentagon²"),
...
1. 29 = 5² + 2² (sum of squares — framework prime criterion)
...
The cosmic budget formula becomes:
  Omega_b = 27/551 = Im_H³ / [(n_c + O)(37 - O)]
          = (generations)³ / [(cosmic sectors)(QCD - color)]
""")

# Verify 37 is framework prime
print(f"\n37 = 6² + 1² = {6**2 + 1**2} (framework prime)")
...
Numerators:
  377 = 13 × 29 = (C² + Im_H²)(37 - O)     [dark energy]
  147 = 3 × 49 = Im_H × Im_O²              [dark matter]
  27  = 3³ = Im_H³                          [baryons]
...
DENSITY FRACTIONS:
  ...
  Omega_DM = 147/551 = 3×49 / 19×29
       = Im_H × Im_O² / [(n_c + O)(37 - O)]
       = generations × color² / cosmic budget
...
print(f"  13 = C² + Im_H² = {C**2} + {Im_H**2} = {C**2 + Im_H**2}")
print(f"  49 = Im_O² = {Im_O**2}")
print(f"  27 = Im_H³ = {Im_H**3}")
...
tests = [
    ("29 is framework prime (5² + 2²)", 29 == 5**2 + 2**2),
    ("29 = 37 - O", 29 == 37 - O),
    ("29 = 19 + 10 = (n_c+O) + (n_c-1)", 29 == (n_c + O) + (n_c - 1)),
    ("29 = 2*n_c + O - 1", 29 == 2*n_c + O - 1),
    ("551 = 19 × 29", 551 == 19 * 29),
    ("377 = 13 × 29", 377 == 13 * 29),
    ("147 = 3 × 49 = Im_H × Im_O²", 147 == Im_H * Im_O**2),
    ("27 = Im_H³", 27 == Im_H**3),
    ("377 + 147 + 27 = 551", 377 + 147 + 27 == 551),
    ("13 = C² + Im_H²", 13 == C**2 + Im_H**2),
]
...
print("""
29 IS A FRAMEWORK PRIME: 29 = 5² + 2²
...
|-----------|-----------|------------------|
| Omega_Lambda = 377/551 | 13 × 29 | (C²+Im_H²)(37-O) |
| Omega_DM = 147/551 | Im_H × Im_O² | generations × color² |
| Omega_b = 27/551 | Im_H³ | baryonic DOF |
