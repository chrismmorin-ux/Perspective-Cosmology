...
print(f"  179 = Im_H² + Im_O² + n_c² = {Im_H**2} + {Im_O**2} + {n_c**2} = {Im_H**2 + Im_O**2 + n_c**2}")
print(f"  137 = H² + n_c² = {H**2} + {n_c**2} = {H**2 + n_c**2}")
...
# sin²θ_W numerator = 19 = n_c + O, and 42 = 2 × 21 = C × (Im_H × Im_O)
...
tests_42 = [
    ...
    ("179 = Im_H² + Im_O² + n_c²", Im_H**2 + Im_O**2 + n_c**2 == 179),
    ("137 = H² + n_c²", H**2 + n_c**2 == 137),
...
# PSL(2,7) order
psl_order = (7**2 - 1) * 7 // 2  # |PSL(2,q)| = q(q²-1)/2 for prime q
print(f"|PSL(2,7)| = 7 × (7² - 1) / 2 = 7 × 48 / 2 = {psl_order}")
...
print(f"          45 = Im_H² × (R+H) = {Im_H**2 * (R + H)}")
