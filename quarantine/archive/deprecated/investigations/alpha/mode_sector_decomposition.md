...
**S253 NOTE**: n_d = 4 and n_c = 11 are now [DERIVED from CCP (AXM_0120)], not imports. CCP forces division algebra structure, giving n_d = dim(H) = 4 and n_c = Im_C+Im_H+Im_O = 11. F = C is also [D: CCP], giving U(n) structure.
