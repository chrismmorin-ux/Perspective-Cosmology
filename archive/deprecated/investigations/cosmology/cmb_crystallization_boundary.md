...
**Confidence**: [CONJECTURE] — 12 observables claimed with 0 free parameters. HRS 9/10: no verification scripts exist for any observable. Arithmetic VERIFIED (cmb_boundary_observables.py, 12/12 PASS, S264). Physics derivations remain [CONJECTURE]. Several formulas may be post-hoc identifications. Downgraded from [DERIVATION] in S264 quality audit.
...
**Arithmetic verification**: `verification/sympy/cmb_boundary_observables.py` (12/12 PASS, S264) — verifies formula arithmetic only, NOT physics derivations
...
2. [CONJECTURE] Three generations each contribute 1/3 of boundary fluctuations [A-STRUCTURAL]
...
2. Deviation from 1 encodes crystallization "tilt" [A-PHYSICAL: CMB tilt interpretation]
3. n_d = 4 spacetime dimensions create the tilt [D: from Frobenius [I-MATH: Frobenius theorem]]
