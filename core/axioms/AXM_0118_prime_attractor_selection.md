...
| 17 | 1^2 + 4^2 | Weak angle or mass ratio |
| 53 | 2^2 + 7^2 | Color-complex coupling |
| 113 | 7^2 + 8^2 | Pure color quantity |

### Weinberg Angle

Preliminary test: 17/73 = 0.2329, which is 0.72% from sin^2(theta_W) = 0.231.

If confirmed: sin^2(theta_W) = 17/73 connects R+H structure (17) to H+O structure (73).
