...
**Thread**: [alpha | dark_sector | primes | gauge | foundation | cosmology]
**Score**: [1-5] (1=speculative, 5=breakthrough)
**Sessions since capture**: [increment each session]
**Insight**: [2-3 sentences max]
**Next**: [What would verify this?]
```

**Lifecycle**: 0-2 sessions = developing | 3-4 = review | 5+ = STALE (must decide)
