...
|---|-----------|-----------------|-----------|-------|
| C1 | Three generations | **DERIVED** | pauli_exclusion_generations.py (12/12) + partial_to_derived_audit.py (17/17) | 3 = Im_H = {i,j,k} [THEOREM: Frobenius + uniqueness]. Only H has Im_dim=3 among all division algebras. H acts on defect (THM_0484) -> 3 independent fermion copies. [A-PHYSICAL]: Im_H=generation index (structurally forced, not free parameter). |
