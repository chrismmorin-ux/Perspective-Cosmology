# Variant 1: Derivation Challenge — Copy-Paste Prompt

**Purpose**: Ask an LLM to derive n_d, n_c, and dimensionless ratios from framework axioms.
...
- **Gemini**: Use the version below that wraps system instructions in `[INSTRUCTIONS: ...]` brackets. Otherwise identical content.
...
*Prompt created Session 132. Extracted from Runbook Session 135.*
