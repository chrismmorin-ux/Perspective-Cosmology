...
Every script MUST: state assumptions explicitly, perform calculation, compare to measurement, include verification tests with PASS/FAIL output.
...
2. **Confirmation Bias**: Remembering successes, forgetting failures. Remedy: Document failed attempts.
